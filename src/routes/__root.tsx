...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TradePilot AI — Indian Stock & Options Paper Trading" },
      { name: "description", content: "Premium AI-powered paper trading platform for NIFTY, BANKNIFTY and Indian stocks. Scanners, options analysis, AI signals, journal and analytics." },
      { property: "og:title", content: "TradePilot AI — Indian Stock & Options Paper Trading" },
      { property: "og:description", content: "Premium AI-powered paper trading platform for NIFTY, BANKNIFTY and Indian stocks. Scanners, options analysis, AI signals, journal and analytics." },
